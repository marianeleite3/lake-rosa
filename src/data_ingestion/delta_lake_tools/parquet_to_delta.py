...
class ParquetToDelta:
    def __init__(self, spark: BronzeIngestion):
        self.spark = spark
        self.unique_columns = []
    ...
    def ingest_initial_parquet_to_delta(self, parquet_path: str):
        ...
        self.spark.write(delta_df, partition_columns=self.partition_columns, database_name=self.database_name, table_name=self.table_name)
